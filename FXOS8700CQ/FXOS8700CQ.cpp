...
Data FXOS8700CQ::get_values()
{
    ...
    values.ax = (int16_t)(((data[1] << 8) | data[2]));
    values.ay = (int16_t)(((data[3] << 8) | data[4]));
    values.az = (int16_t)(((data[5] << 8) | data[6]));

    // copy the magnetometer byte data into 16 bit words
    values.mx = (int16_t) (data[7] << 8) | data[8];
    values.my = (int16_t) (data[9] << 8) | data[10];
    values.mz = (int16_t) (data[11] << 8) | data[12];
